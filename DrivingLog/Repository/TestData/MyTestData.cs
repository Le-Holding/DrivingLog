...
namespace DrivingLog.Repository.TestData
{
  public class MyTestData
  {
    ...
    public List<EmployeeStamdataDto> GetPersons()
    {
      ...
      {
        new EmployeeStamdataDto { Id = 1, Name = "Jalina", LicensePlate = "CP86028", Date = new DateTime(2020, 08, 1) },
        new EmployeeStamdataDto { Id = 2, Name = "Melina", LicensePlate = "AR86028", Date = new DateTime(2020, 01, 1) },
